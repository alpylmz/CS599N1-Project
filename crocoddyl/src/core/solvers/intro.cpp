...
bool SolverIntro::solve(const std::vector<Eigen::VectorXd>& init_xs,
  ...
  START_PROFILER("SolverIntro::solve::loop1");
  bool recalcDiff = true;
  for (iter_ = 0; iter_ < maxiter; ++iter_) {
    START_PROFILER("SolverIntro::solve::loop2");
    while (true) {
      try {
    ...
    STOP_PROFILER("SolverIntro::solve::loop2");
    START_PROFILER("SolverIntro::solve::expectedImprovement");
    updateExpectedImprovement();
    expectedImprovement();
    STOP_PROFILER("SolverIntro::solve::expectedImprovement");

    START_PROFILER("SolverIntro::solve::updatepenaltyparameter");
    ...
    STOP_PROFILER("SolverIntro::solve::updatepenaltyparameter");

    START_PROFILER("SolverIntro::solve::calcDerivatives");
    ...
    STOP_PROFILER("SolverIntro::solve::calcDerivatives");

    START_PROFILER("SolverIntro::solve::callbacks");
    stoppingCriteria();
    ...
    STOP_PROFILER("SolverIntro::solve::callbacks");

    START_PROFILER("SolverIntro::solve::regularization");
    ...
    STOP_PROFILER("SolverIntro::solve::regularization");
  ...
  STOP_PROFILER("SolverIntro::solve::loop1");
  STOP_PROFILER("SolverIntro::solve");
  return false;
}
